...
router.get('/users/:userId/shop-access', checkSuperadmin, userController.getShopAccess);
router.delete('/users/removeShopAccess/:userId', checkSuperadmin, userController.removeShopAccess);
router.get('/users/:userId/groups/:groupName/tables', checkSuperadmin, userController.getGroupTables);
router.get('/users/getUserGroupsAndShops/:userId',checkSuperadmin, userController.getUserGroupsAndShops);
